...
t_try_catch_statement create_try_catch_statement()
{
  ...
  statement.label_end = NULL;
  statement.label_catch = NULL;

  return statement;
}

t_either_or_statement create_either_statement()
{
  t_either_or_statement statement;
...
t_for_statement create_for_statement()
{
  ...
  statement.label_exit = NULL;
  statement.label_exp = NULL;
  statement.label_code_block = NULL;
